 ...
 * http://www.jqueryscript.net/menu/Mobile-friendly-Multi-level-Dropdown-Menu-Plugin-jQuery-Stellarnav.html
	...
	$.fn.stellarNav = function(options, width, breakpoint) {
		...
		return this.each( function() {
			...
			if (settings.phoneBtn) {
				...
				var btn = '<li class="call-btn-mobile ' + cssClass + '"><a href="tel:'+ settings.phoneBtn +'"><i class="icon-phone icons"></i> Call us</a></li>';
				nav.find('nav > ul').prepend(btn);
			...
			nav.prepend('<a href="#" class="menu-toggle"><i class="icon-menu icons"></i> Menu</a>');
			...
			nav.find('li a').each(function() {
				if ($(this).next().length > 0) {
					$(this).parent('li').addClass('has-sub').append('<a class="dd-toggle" href="#"><i class="icon-plus icons"></i></a>');
				}
			});

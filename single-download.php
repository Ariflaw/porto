...
<div class="ps_pagination">
    ...
    <li class="menu_nav"><a href="<?php echo get_post_type_archive_link( 'portfolio' ); ?>"><i class="icon-grid"></i></a></li>
    <li class="next_nav"><?php next_post_link( '%link', 'Next <i class="icon-arrow-right"></i> <span>%title</span>' ); ?></li>
</div>

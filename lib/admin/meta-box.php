...
function your_prefix_meta_boxes( $meta_boxes ) {
    $meta_boxes[] = array(
        ...
        'fields'     => array(
            ...
            array(
                'name'       => esc_html__( 'Start Project', 'your-prefix' ),
                'id'         => "star-project-folio",
                'type'       => 'date',
            ...
            array(
                'name'       => esc_html__( 'Done Project', 'your-prefix' ),
                'id'         => "done-project-folio",
                'type'       => 'date',
            ...
            array(
                'id'   => 'hours-folio',
                'name' => __( 'Hours Speend', 'textdomain' ),
                'type' => 'text',
                'desc' => esc_html__( 'hours', 'your-prefix' ),
                'placeholder' => esc_html__( '50', 'your-prefix' ),
            ),
        ),
    );
    return $meta_boxes;
